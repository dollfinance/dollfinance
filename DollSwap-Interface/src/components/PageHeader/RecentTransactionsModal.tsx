...
const RecentTransactionsModal = ({ onDismiss = defaultOnDismiss, translateString }: RecentTransactionsModalProps) => {
  ...
  return (
    <Modal title={TranslateString(1202, 'Recent transactions')} className="modal_header" onDismiss={onDismiss}>
      {!account && (
        <Flex justifyContent="center" flexDirection="column" alignItems="center">
          <Text mb="8px" bold color="textSubtle">
            Please connect your wallet to view your recent transactions
          </Text>
          <Button variant="subtle" scale="sm" onClick={onDismiss} className="pink_btn">
            Close
          </Button>
        </Flex>
      )}
